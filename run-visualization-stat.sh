...
JOBS_CSV="$OUTPUT_DIR/statisticjobs.csv"
ENERGY_CSV="$OUTPUT_DIR/statisticconsumed_energy.csv"
MSTATES_CSV="$OUTPUT_DIR/statisticmachine_states.csv"
PSTATES_CSV="$OUTPUT_DIR/statisticpstate_changes.csv"
